...
The expert network's example profiles are the third (owner decision of 2026-09-14). They carried a major opener -- "Who turns up. Six examples." over a lead -- until then, and what it announced the page already says twice over: the cards sit directly under the hero, whose `h1` is "Senior people. No juniors.", and the band's own disclosure note opens it by saying these are example profiles. The note stays, because invented people on a public page have to announce themselves, and with the opener gone it is the band's first line rather than a gloss under the lead. Unlike the pricing packages this band keeps both of its tier's paddings even though it too sits under an anchor: the hero's own control sits at the foot of that anchor, so the space between is separating a button from a grid rather than leaving dead white under a lead.
...
| Expert network | anchor opener, centred · major profiles, openerless · major the standard · **major ruled vetting** · minor matching and coverage · anchor jet closing |
