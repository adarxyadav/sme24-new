...
- [ ] Build it: `/develop peer bubble chart`
  ...
  - [ ] The rows, the recompute and the thread: Symrise and Covestro, the four quotient rows with Vinci's note, the pgTAP counts, the `@6` recompute boxes in the runbook, the e2e chart assertions and axe (AC-23, AC-24, AC-25)
