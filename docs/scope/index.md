...
| 11 | Package checkout with Swiss VAT | Slice 3 | in-progress |
...
| 27 | Named peer comparison | Slice 5 | in-progress |
...
- [Client funnel](client.md) · 6 to 10, 22, 23, 27 · 4 of 8 done · sign in, company lookup, AI research, benchmark and CHF opportunity, plus later named peer comparison, team and notification strands.
