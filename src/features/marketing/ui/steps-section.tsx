 ...
 * It keeps the major tier and sits on the page ground: the ruled field came off on 2026-09-10
 * (owner decision), because the rules ran vertically behind a column the reader travels down and
 * read as a second grid competing with the one hairline that carries the sequence.
 * Server component; only the rail's highlight is client side.
 */
