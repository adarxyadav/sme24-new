    ...
    <section aria-labelledby="steps-heading" data-steps>
      ...
      */}
      ...
      >
        ...
        */}
        <div className="lg:sticky lg:top-16 lg:flex lg:h-[calc(100svh-4rem-var(--consent-bar-height,0px))] lg:flex-col lg:overflow-hidden">
          ...
          */}
          <div className="mx-auto w-full max-w-6xl shrink-0 px-4 pt-16 pb-10 sm:px-6 md:pt-28 lg:border-b lg:px-12 lg:pt-10 lg:pb-10">
            <SectionHeader
              tier="major"
              id="steps-heading"
              eyebrow={eyebrow}
          ...
          */}
          <div className="mx-auto w-full max-w-6xl px-4 pb-16 sm:px-6 md:pb-28 lg:grid lg:min-h-0 lg:flex-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,2.4fr)] lg:items-start lg:gap-16 lg:px-12 lg:pb-0">
            {/*
            ...
            */}
            <ol className="flex flex-col border-border border-t lg:gap-1 lg:self-start lg:border-t-0 lg:pt-10">
