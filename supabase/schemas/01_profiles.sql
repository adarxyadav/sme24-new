...
-- the seed), defaulting to client. full_name and locale come from user metadata when present
-- (display data only, never authorization); an unknown locale falls back to de.
